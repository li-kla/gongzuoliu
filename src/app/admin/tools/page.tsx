      ...
      <div className="flex-1 flex flex-col md:ml-56">
        ...
        <div className="bg-white shadow-sm z-40">
          <div className="flex items-center justify-between px-4 py-3">
            <div className="flex items-center">
              ...
              <h2 className="ml-4 text-xl font-bold text-gray-900 md:ml-0">工具集</h2>
            </div>
        ...
        <div className="flex-1 p-4 md:p-6">
          ...
          <div className="mb-6 flex items-center text-sm">
            ...
            <span className="text-gray-700 font-medium">工具集</span>
          </div>

          {/* 操作栏 */}
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-gray-900">工具集</h1>
          </div>

          {/* 工具卡片 */}
          <div className="grid grid-cols-1 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">系统工具</h2>
              <p className="text-gray-600">工具集功能正在开发中，敬请期待！</p>
            </div>
          </div>
        </div>
      </div>

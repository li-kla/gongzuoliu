      ...
      <div className="flex-1 flex flex-col md:ml-56">
          ...
          <div className="flex items-center justify-between px-4 py-3">
            <div className="flex items-center">
              <div className="flex items-center space-x-4">
                ...
                <h2 className="text-xl font-bold text-gray-900">工作流管理</h2>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              {/* 搜索框 */}
        ...
        <div className="flex-1 p-4 md:p-6">
          ...
          <div className="mb-6 flex items-center text-sm">
            ...
            <span className="text-gray-700 font-medium">工作流管理</span>
          </div>

          {/* 操作栏 */}
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-gray-900">工作流管理</h1>
            <Link href="/admin/articles/create" className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
              创建工作流
            </Link>
          </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="mt-1 max-w-2xl text-sm text-gray-500">
                          工作流：{workflow.workflowName} | 作者：{workflow.author.username} | {new Date(workflow.createdAt).toLocaleDateString()}
                        </p>
                      </div>
                      <div className="ml-5 flex-shrink-0 flex">
                        <Link
                          href={`/admin/articles/edit/${workflow._id}`}
                          className="px-3 py-1 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 mr-2"
                        >
                          编辑
                        </Link>
                        <button
